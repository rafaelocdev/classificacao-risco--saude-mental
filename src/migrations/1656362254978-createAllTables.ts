...
export class createAllTables1656362254978 implements MigrationInterface {
    name = 'createAllTables1656362254978'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cpf" character varying NOT NULL, "birthday" character varying NOT NULL, "gender" character varying NOT NULL, "email" character varying NOT NULL, "mobile" character varying NOT NULL, "street" character varying NOT NULL, "number" character varying NOT NULL, "complement" character varying NOT NULL, "zip" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "confirmation_status" boolean NOT NULL DEFAULT false, "confirmation_code" uuid NOT NULL, CONSTRAINT "UQ_87465aba2ccd4e4a3c6a5918fbc" UNIQUE ("cpf"), CONSTRAINT "UQ_869f60dec8abe7e46edaf786f6f" UNIQUE ("email"), CONSTRAINT "PK_2533602bd9247937e3a4861e173" PRIMARY KEY ("id"))`);
