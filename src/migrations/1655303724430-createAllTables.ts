...
export class createAllTables1655303724430 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "on_duty" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "on_duty" boolean NOT NULL DEFAULT false, "available" boolean NOT NULL DEFAULT false, "employee_id" uuid, CONSTRAINT "REL_e776196af7b554e794aed42349" UNIQUE ("employee_id"), CONSTRAINT "PK_83937bf600f1bf514081360b9db" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "anamnesis" character varying, "action" character varying, "on_duty_id" uuid, "query_mh_risk_id" uuid NOT NULL, CONSTRAINT "REL_a6e509779614c9ffb1cb7ad7c2" UNIQUE ("query_mh_risk_id"), CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "employees" ADD CONSTRAINT "FK_9d6a984962f1ed664423451e565" FOREIGN KEY ("data_id") REFERENCES "data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "on_duty" ADD CONSTRAINT "FK_e776196af7b554e794aed423495" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "clients" ADD CONSTRAINT "FK_0905bbabdf4fb87584a45d2b821" FOREIGN KEY ("data_id") REFERENCES "data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "query_mh_risk" ADD CONSTRAINT "FK_3a26f849a0c6229819f1cdef9e8" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "query_mh_risk" ADD CONSTRAINT "FK_15a70df7c654903f5636bc51134" FOREIGN KEY ("result_mh_risk_id") REFERENCES "result_mh_risk"("risk") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "appointments" ADD CONSTRAINT "FK_8116581e90af53235660de94bf3" FOREIGN KEY ("on_duty_id") REFERENCES "on_duty"("employee_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "appointments" ADD CONSTRAINT "FK_a6e509779614c9ffb1cb7ad7c23" FOREIGN KEY ("query_mh_risk_id") REFERENCES "query_mh_risk"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "appointments" DROP CONSTRAINT "FK_a6e509779614c9ffb1cb7ad7c23"`,
    );
    await queryRunner.query(
      `ALTER TABLE "appointments" DROP CONSTRAINT "FK_8116581e90af53235660de94bf3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "query_mh_risk" DROP CONSTRAINT "FK_15a70df7c654903f5636bc51134"`,
    );
    await queryRunner.query(
      `ALTER TABLE "query_mh_risk" DROP CONSTRAINT "FK_3a26f849a0c6229819f1cdef9e8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "clients" DROP CONSTRAINT "FK_0905bbabdf4fb87584a45d2b821"`,
    );
    await queryRunner.query(
      `ALTER TABLE "on_duty" DROP CONSTRAINT "FK_e776196af7b554e794aed423495"`,
    );
    await queryRunner.query(
      `ALTER TABLE "employees" DROP CONSTRAINT "FK_9d6a984962f1ed664423451e565"`,
    );
